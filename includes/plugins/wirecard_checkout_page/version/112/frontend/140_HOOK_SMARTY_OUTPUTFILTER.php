...
if (Shop::getPageType() == PAGE_BESTELLVORGANG && $step == 'Bestaetigung') {
    ...
    if (($_SESSION['Zahlungsart']->cModulId == "kPlugin_{$kPlugin}_wirecardcheckoutpageinstallment" && $get_config('wirecard_checkout_page_installment_provider') == 'ratepay') ||
        ($_SESSION['Zahlungsart']->cModulId == "kPlugin_{$kPlugin}_wirecardcheckoutpageinvoice" && $get_config('wirecard_checkout_page_invoice_provider') == 'ratepay')) {
